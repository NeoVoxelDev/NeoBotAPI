...
import dev.neovoxel.nbapi.event.NUndefinedEvent;
...
import dev.neovoxel.nbapi.event.message.PrivateMessageType;
import dev.neovoxel.nbapi.event.meta.HeartbeatEvent;
import dev.neovoxel.nbapi.event.meta.LifecycleEvent;
