...
import dev.neovoxel.nbapi.discord.DiscordException;
...
public class DiscordGatewayClient extends WebSocketClient implements DiscordClient {
    ...
    private final ScheduledExecutorService heartbeatExecutor = Executors.newSingleThreadScheduledExecutor(runnable -> {
        Thread thread = new Thread(runnable, "neobotapi-discord-heartbeat");
    ...
    private void identify() {
        JSONObject properties = new JSONObject()
                ...
                .put("browser", "NeoBotAPI")
                .put("device", "NeoBotAPI");
    ...
    private HttpRequestBase createRequest(String method, String path, JSONObject body) {
        ...
        request.setHeader("User-Agent", "DiscordBot (https://github.com/NeoVoxelDev/NeoBotAPI, 1.0)");
        if (body != null) {
